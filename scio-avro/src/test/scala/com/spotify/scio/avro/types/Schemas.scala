...
object Schemas {
  ...
  def basicFields(mode: FieldMode = NONE): String =
    s"""
       ...
       |  "fields": [
       |    { "name": "boolF", "type": ${fieldType("\"boolean\"", mode)} ${setDefaultValue(mode)}},
       |    { "name": "intF", "type": ${fieldType("\"int\"", mode)} ${setDefaultValue(mode)}},
       |    { "name": "longF", "type": ${fieldType("\"long\"", mode)} ${setDefaultValue(mode)}},
       |    { "name": "floatF", "type": ${fieldType("\"float\"", mode)} ${setDefaultValue(mode)}},
       |    { "name": "doubleF", "type": ${fieldType("\"double\"", mode)} ${setDefaultValue(mode)}},
       |    { "name": "stringF", "type": ${fieldType("\"string\"", mode)} ${setDefaultValue(mode)}},
       |    { "name": "byteStringF", "type": ${fieldType("\"bytes\"", mode)} ${setDefaultValue(mode)}}
       |  ]
       |}
       |""".stripMargin
